import './WtrMapWaveDivider.scss'

type Props = {
  className?: string
}

/** Decorative wave between map canvas and toolbar controls. */
export function WtrMapWaveDivider({ className }: Props) {
  return (
    <div
      className={['wtr-map-wave-divider', className].filter(Boolean).join(' ')}
      aria-hidden
    >
      <svg
        className="wtr-map-wave-divider__svg"
