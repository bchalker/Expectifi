...
export function DestinationTaxVisaTab({ country, staggerClassName, staggerStyle }: Props) {
  ...
  if (!data) {
    return (
      <p
        ...
        {...staggerSectionProps(0, 'wtr-tax-visa__empty', staggerClassName, staggerStyle)}
      >
        {TAX_VISA_UNAVAILABLE_MESSAGE}
      </p>
    )
  ...
  return (
    <div className="wtr-tax-visa">
      <p
        ...
        {...staggerSectionProps(0, 'wtr-tax-visa__scope', staggerClassName, staggerStyle)}
      >
        <ScopeIcon className="wtr-tax-visa__scope-icon" size={14} stroke={1.5} aria-hidden />
        <span>{scope.text}</span>
      </p>
      <section
        className="wtr-tax-visa__group"
        aria-labelledby="wtr-tax-visa-tax-heading"
        {...staggerSectionProps(1, 'wtr-tax-visa__group', staggerClassName, staggerStyle)}
      >
        ...
        <dl className="wtr-tax-visa__rows">
          <div className="wtr-tax-visa__row">
            ...
            <dd className="wtr-tax-visa__value wtr-tax-visa__value--prominent">{data.tax_rate_label}</dd>
          </div>
          <div className="wtr-tax-visa__row">
          ...
          <div className="wtr-tax-visa__row">
            <dt className="wtr-tax-visa__label">Key exemptions &amp; treaties</dt>
            <dd className="wtr-tax-visa__value">{data.key_exemptions}</dd>
            {data.us_tax_treaty ? (
              <span className="wtr-tax-visa__treaty-badge">US Tax Treaty ✓</span>
            ) : null}
          </div>
        </dl>
      </section>
      ...
      <section
        ...
        {...staggerSectionProps(2, 'wtr-tax-visa__group', staggerClassName, staggerStyle)}
      >
        ...
        <dl className="wtr-tax-visa__rows">
          <div className="wtr-tax-visa__row">
            ...
            <dd className="wtr-tax-visa__value wtr-tax-visa__value--prominent">{data.visa_name}</dd>
          </div>
          <div className="wtr-tax-visa__row">
            <dt className="wtr-tax-visa__label">Income requirement</dt>
            <dd className="wtr-tax-visa__value">{data.visa_income_requirement}</dd>
          </div>
          <div className="wtr-tax-visa__row">
      ...
      <section
        ...
        {...staggerSectionProps(3, 'wtr-tax-visa__group', staggerClassName, staggerStyle)}
      >
        <h3 id="wtr-tax-visa-health-heading" className="wtr-tax-visa__section-title">
      ...
      <p
        ...
        {...staggerSectionProps(4, 'wtr-tax-visa__disclaimer', staggerClassName, staggerStyle)}
      >
