...
export function WtrMapPinColorChrome({
  ...
  const { description } = mapPinViewChromeCopy(pinColorView);
  ...
  return (
    ...
    >
      {/* Tabler has no matching wave divider — custom SVG per design */}
      <div className="wtr-pin-color-chrome__wave-divider" aria-hidden>
        <svg
          className="wtr-pin-color-chrome__wave-divider-svg"
      ...
      <div className="wtr-pin-color-chrome__toolbar">
        ...
        <span className="wtr-pin-color-chrome__toolbar-divider" aria-hidden />
