...
import type { CalculatorInputs, CalculatorUi, ComputeBalanceModes } from '../lib/computeResults'
...
export function RetirementAgeSensitivityTrigger({
  ...
  return (
    <div
      className={['retirement-sensitivity-trigger', className].filter(Boolean).join(' ')}
    >
      <button
        type="button"
      ...
      >
        <span className="growth-slider-label__panel-rate-lead font-xs">When I am</span>
        <span className="retirement-sensitivity-trigger__age tabular-nums">{retirementAge}</span>
...
export function RetirementAgeSensitivityOverlay({
  ...
  const [selectedColumnIndex, setSelectedColumnIndex] = useState(SET_AGE_COLUMN_INDEX)
      ...
      >
        <header className="retirement-sensitivity__header">
          <div className="retirement-sensitivity__header-main">
            <h2 id="retirement-sensitivity-title" className="retirement-sensitivity__title">
        ...
        <div className="retirement-sensitivity__table-wrap">
          <table className="retirement-sensitivity__table">
            <thead>
              <tr>
                <th className="retirement-sensitivity__label-col" scope="col" aria-hidden />
                  ...
                  return (
                    <th
                      ...
                      className={[
                        ...
                        isSelected && !isSetAge && 'retirement-sensitivity__age-col--selected',
                      ]
                        .filter(Boolean)
                        .join(' ')}
                    >
            ...
            <tfoot>
              <tr className="retirement-sensitivity__set-row">
                <th className="retirement-sensitivity__label-col" scope="row" aria-hidden />
                {table.columns.map((col, columnIndex) => {
                  const isSelected = columnIndex === selectedColumnIndex
                  const isSetAge = col.isSetAge
                  return (
