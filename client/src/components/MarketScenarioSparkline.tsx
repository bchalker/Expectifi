...
export type MarketScenarioSparklineDeltaTone = 'positive' | 'negative' | 'neutral'
...
function MarketScenarioChartTooltip({ active, payload }: ChartTooltipProps) {
  ...
  if (!row) return null
  return (
    <div className="market-scenario-sparkline__tooltip market-scenario-sparkline__tooltip--chart" role="status">
      <span className="market-scenario-sparkline__tooltip-year">{row.year}</span>
...
export function MarketScenarioSparkline({
  ...
  const scenarioEnd = series.scenarioValues[series.scenarioValues.length - 1] ?? 0
  ...
  return (
    <div
      className={['market-scenario-sparkline', className].filter(Boolean).join(' ')}
    >
        ...
        >
          ...
          >
            ...
            >
              <defs>
                ...
                <linearGradient id={scenarioGradientId} x1="0" y1="0" x2="0" y2="1">
                  <stop
                    offset="0%"
              ...
              <XAxis
                ...
                tick={{ className: 'market-scenario-sparkline__axis-tick' }}
                padding={{ left: 0, right: 0 }}
              />
              <YAxis hide domain={['dataMin', 'dataMax']} />
              <Tooltip
                content={(props) => (
                  <MarketScenarioChartTooltip active={props.active} payload={props.payload} />
                )}
                cursor={{
                  stroke: 'var(--border)',
                  strokeWidth: 1,
              ...
              <Line
                ...
                dot={false}
                activeDot={{
                  className: 'market-scenario-sparkline__active-dot market-scenario-sparkline__active-dot--base',
                  r: 3,
                }}
                {...seriesAnimProps}
                legendType="none"
          ...
          <div className="market-scenario-sparkline__legend-pill" aria-hidden>
            <span className="market-scenario-sparkline__legend-item market-scenario-sparkline__legend-item--scenario">
              <span className="market-scenario-sparkline__legend-dot" aria-hidden />
            ...
            <span className="market-scenario-sparkline__legend-item market-scenario-sparkline__legend-item--base">
              <span className="market-scenario-sparkline__legend-dash" aria-hidden />
              <span className="market-scenario-sparkline__legend-text">
                Base · {fmt(baseEnd)}
              </span>
            </span>
