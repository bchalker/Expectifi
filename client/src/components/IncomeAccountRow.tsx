...
export function IncomeAccountRow({
  ...
  const strategySubtext = (
    <span className="income-account-row__strategy-line">
      <span className="income-account-row__strategy-badge">{breakdown.strategyBadgeLabel}</span>
    ...
    <details className="tax-treatment-disclosure portfolio-account-group income-account-row">
      <summary className="tax-treatment-disclosure__summary portfolio-bucket-account-summary">
        <FidelityBucketAccountRow
          ...
          total={<AccountBucketMonthlyIncomePill monthlyIncome={breakdown.monthlyTotal} />}
          valuesExtra={
            <span className="income-account-row__balance" aria-label="Projected balance at retirement">
